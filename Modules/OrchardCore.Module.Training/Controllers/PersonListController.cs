...
public class PersonListController : Controller
{
    ...
    // See it under /OrchardCore.Modules.Training/PersonList/OlderThan30.
    public async Task<IActionResult> OlderThan30()
    {
        ...
        foreach (var person in people)
        {
            ...
            var shape = await _contentItemDisplayManager.BuildDisplayAsync(person, _updateModelAccessor.ModelUpdater, "Summary");
...
#pragma warning restore S1643 // Strings should not be concatenated using '+' in a loop
    ...
    public async Task<string> CreateAnAndroid()
    {
        ...
        var person = await _contentManager.NewAsync("PersonPage");
